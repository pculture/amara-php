...
/**
 *
 * Needed to send the requests to BC'S API
 * Source: https://support.brightcove.com/learning-guide-using-rest-apis#Proxy_code
 *
...
function log_error($php_log, $curl_error) {
    ...
    $logFileLocation = $_SERVER['HOME'] . ".bcfeed_log.txt";
